...
const RemotionVideo = ({ videoScript, audioFileUrl, captions, imageList, setDurationInFrame }) => {
    ...
    const getCurrentCaptions = () => {
        const currentTime = (frame / 30) * 1000; // Convert 30fps frame number to milliseconds
